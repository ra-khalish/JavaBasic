...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("puss equals popo? " + puss.equals(popo));

        System.out.println("-----------");

        Object o = new Kucing(); // kucing adalah object
        Hewan h = new Kucing(); // kucing adalah hewan
        Kucing k = new Kucing(); // kucing adalah kucing, pastinya wkwkwk
        ...
        Mamalia kucingbaru = new Kucing();
        System.out.println(kucingbaru.apakek);
